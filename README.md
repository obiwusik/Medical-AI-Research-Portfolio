...
Welcome to my research portfolio containing implementation frameworks and reproducible code links for my peer-reviewed Artificial Intelligence and Healthcare Analytics research.
...
## 📚 Publications and Code Implementations
...
## 📊 Dataset Information
Public dataset is used in this study. the dataset can be accessed via https://www.kaggle.com/datasets/hamdallak/the-iqothnccd-lung-cancer-dataset
